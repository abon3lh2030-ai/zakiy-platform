...
const SL_BODY_IMAGES = {
  ...
  elephant: {
    // رسم تشريح فيل مخصص (مرسوم يدويًا وبعنوان عربي أصلاً) - ملف محلي
    // بالمشروع مو رابط خارجي، ما فيه رئتين ولا جلد واضحين بهذا الرسم
    url: '/assets/animals/elephant.jpg',
    credit: null,
    hotspots: [
      { part: 'brain', x: 22.5, y: 30.2 },
      { part: 'heart', x: 40.7, y: 40.9 },
      { part: 'liver', x: 48.7, y: 42.7 },
      { part: 'stomach', x: 52.2, y: 47.4 },
      { part: 'intestines', x: 62.5, y: 48.6 },
      { part: 'kidneys', x: 72, y: 26.7 },
      { part: 'kidneys', x: 75.2, y: 34.4 },
    ],
  },
  crocodile: {
    // رسم تشريح تمساح مخصص (مرسوم يدويًا وبعنوان عربي أصلاً) - ملف
    // محلي بالمشروع مو رابط خارجي
    url: '/assets/animals/crocodile.jpg',
    credit: null,
    hotspots: [
      { part: 'brain', x: 23, y: 19.4 },
      { part: 'heart', x: 42.8, y: 47.5 },
      { part: 'liver', x: 44.9, y: 41 },
      { part: 'lungs', x: 52.2, y: 36.7 },
      { part: 'stomach', x: 52.8, y: 48.6 },
      { part: 'intestines', x: 64.8, y: 41 },
      { part: 'kidneys', x: 72.6, y: 37.8 },
      { part: 'skin', x: 86.7, y: 64.8 },
    ],
  },
  cat: {
