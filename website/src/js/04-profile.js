...
function showAccountScreen(id) {
  ...
  if (wrapEl) wrapEl.classList.toggle('wrap-wide', id === 'step-robotics-lab' || id === 'step-science-lab' || id === 'step-smart-quran');
}
