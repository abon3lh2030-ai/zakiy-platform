...
function renderAdminAnalytics(data) {
  ...
  const operationLabels = { new_subscription:t('operation_new_subscription'), renewal:t('operation_renewal'), trial_started:t('operation_trial'), auto_renew_cancelled:t('operation_cancel_renewal'), discount_code:t('operation_discount_code'), redemption_code:t('operation_redemption_code') };
